    ...
    <section className='pagina-artigo'>
      ...
      <div className='box-artigo-aside'>
        <article className='artigo-blog'>
          <img src={ artigo.length && artigo[0].imagens[0] } alt="Imagem de um saco de terra junto com uma pá" />
          ...
          <img src={ artigo.length && artigo[0].imagens[1] } alt="Imagem de duas mãos plantando uma arvore" />
