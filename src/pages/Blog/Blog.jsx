...
import destaque from '../../images/post-destaque.svg';
  ...
  return (
    <div>
      <article className='banner-blog'>
        <p><span>GERMINNE</span> SEU <span>CONHECIMENTO</span> COM A GENTE!</p>
      </article>

      <article className='post-destaque'>
        <h3>Post em <span>destaque</span></h3>
        <a href="">
          <img src={destaque} alt="Imagem do Telhado Verde no Eldorado" />
          <p><span>Fazenda urbana</span> do iFood</p>
        </a>
      </article>
