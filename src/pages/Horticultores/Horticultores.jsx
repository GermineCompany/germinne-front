  ...
  return (
    <div>
      ...
      <div>
        ...
        <h2 className='titulo-banner-horticultor'>Encontre <span>agora</span> o profissional ideal para <span>você</span></h2>

        <div className='banner-horticultor'>
          <div>
            <h2>Consulte agora um <span>Horticultor</span> e solicite um orçamento de forma totalmente <span>gratuita</span>:</h2>
