  ...
  return (
    <div>
      <div className="banner-horticultor">
        <div>
          <h2>
            Encontre agora um <span>profissional</span> e solicite um orçamento{" "}
            <span>gratuito</span>.
          </h2>
      ...
      <div className="main-container-limitador">
        <div className="box-como-funciona">
          <img
            ...
            src="https://germinnecomp-img.s3.sa-east-1.amazonaws.com/comoFunciona.svg"
            alt="imgComoFunciona"
          />
          ...
          <div className="box-texto-como-funciona">
            <h2>Como funciona?</h2>
            <ComoFunciona
              urlImg="https://germinnecomp-img.s3.sa-east-1.amazonaws.com/Passo+1.svg"
              altImg="icone1"
              conteudo="Responda as questões sobre o tipo de trabalho, onde será feito e o tamanho aproximado do espaço."
            />

            <ComoFunciona
              urlImg="https://germinnecomp-img.s3.sa-east-1.amazonaws.com/Passo+2.svg"
              altImg="icone2"
              conteudo="Acesse serviços de horticultura e tenha hortas facilmente acessíveis!"
            />

            <ComoFunciona
              urlImg="https://germinnecomp-img.s3.sa-east-1.amazonaws.com/Passo3.svg"
              altImg="icone3"
            ...
            <ComoFunciona
              urlImg="https://germinnecomp-img.s3.sa-east-1.amazonaws.com/Passo4.svg"
              altImg="icone4"
        ...
        <div className="box-servicos">
          ...
          <div className="box-card-servicos-horticultores">
            <ArticleBeneficios
              urlImg="https://germinnecomp-img.s3.sa-east-1.amazonaws.com/servico1.svg"
            ...
            <ArticleBeneficios
              urlImg="https://germinnecomp-img.s3.sa-east-1.amazonaws.com/servico2.svg"
            ...
            <ArticleBeneficios
              urlImg="https://germinnecomp-img.s3.sa-east-1.amazonaws.com/servico3.svg"
              altImg="Imagem de várias comidas em uma mesa"
      ...
      <div className="box-banner-cadastro-horticultor">
        <div className="banner-cadastro-horticultor">
          <div>
            <h3>
              Aumente sua <span>visibilidade e alcance</span>, atraindo mais
              clientes e <span>expandindo seus negócios</span>.
            </h3>
            <p>
              Ao ingressar como profissional em uma plataforma web, você amplirá
              seu alcance de negócio, promoverá e interajir com outros
              profissionais. Gerencie com eficiência as solicitações dos
              clientes, mantendo controle sobre encomendas, e estabeleça
              confiança ao fornecer informações detalhadas e avaliações aos
              consumidores.
            </p>
