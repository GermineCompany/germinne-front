      ...
      <div className="main-container-limitador">
        <article className="box-card-home">
          ...
          <div className="box-card-germinne">
            <CardHomeGerminne
              title={[
                "Temos a missão de levar o ",
                <span key={1}>verde</span>,
            ...
            <CardHomeGerminne
              title={[
                "Promovemos a ",
                <span key={2}>sustentabilidade</span>,
                " contribuindo para uma cidade mais ",
                <span key={2}>saudável</span>,
              ]}
        ...
        <section className="box-beneficios-agricultura">
          <h2>
            Benefícios da <span>Agricultura Urbana</span>
          </h2>

          <ArticleBeneficios
            urlImg="https://germinnecomp-img.s3.sa-east-1.amazonaws.com/article-image-1.png"
          ...
          <ArticleBeneficios
            urlImg="https://germinnecomp-img.s3.sa-east-1.amazonaws.com/article-image-2.png"
          ...
          <ArticleBeneficios
            urlImg="https://germinnecomp-img.s3.sa-east-1.amazonaws.com/article-image-3.png"
        ...
        <section className="box-avaliacoes">
          <h3>
            <span>Avaliações</span> dos nossos <span>clientes</span>
          </h3>
