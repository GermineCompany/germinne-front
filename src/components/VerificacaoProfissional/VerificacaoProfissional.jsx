...
function VerificacaoProfissional() {
  const { loggedUser: { id, nome } } = useContext(GerminneContext);
    ...
    <div className='verificacao-profissional'>
      {
        verificacaoCompleta && (
          <div className='verificacao-completa'>
            <h2>Parabéns, <span>{ nome }</span>!</h2>
            <img src="https://media.tenor.com/bm8Q6yAlsPsAAAAj/verified.gif" alt="Check verde" />
