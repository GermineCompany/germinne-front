const artigos = [
  {
    artigoId: 1,
    conteudo: `<article id="artigo-blog" className="artigo-blog">
    <figure>
      <img
        src='https://germinnecomp-img.s3.sa-east-1.amazonaws.com/artigoTelhadoVerde.jpg' alt="Imagem do Telhado Verde do Shopping Eldorado"
        id="imagem-artigo"
      />
    ...
    <figure>
      <img
        src='https://germinnecomp-img.s3.sa-east-1.amazonaws.com/artigoTelhadoVerde2.jpg' alt="Imagem do Telhado Verde do Shopping Eldorado"
        id="imagem-artigo"
      />
      <figcaption>Fonte: Nome do Autor</figcaption>
    </figure>
    ...
    fonte: 'Por: Fonte da Informação',
    categoria: 'Hortas Urbanas',
    imagemCard: 'https://germinnecomp-img.s3.sa-east-1.amazonaws.com/artigo8.png',
  ...
  {
    artigoId: 2,
    titulo: 'Agricultura urbana: o que é e quais as vantagens',
    categoria: 'Agricultura Urbana',
    conteudo: `
    <article id="artigo-blog" className="artigo-blog">
      <figure>
        <img
          src='https://germinnecomp-img.s3.sa-east-1.amazonaws.com/PlantaPrincipal.jpg' alt="Imagem de duas mãos plantando uma arvore"
          id="imagem-artigo"
        />
        <figcaption>Fonte: Nome do Autor</figcaption>
      </figure>
      ...
      <figure>
        <img
          src='https://germinnecomp-img.s3.sa-east-1.amazonaws.com/artigoVantagensHorta.jpg' alt="Imagem de uma horta dentro de uma caixa"
          id="imagem-artigo"
        />
        <figcaption>Fonte: Nome do Autor</figcaption>
      </figure>
    ...
    fonte: 'Por BrotaCompany',
    descricao: 'Agricultura e urbana, duas palavras que poderiam não fazer sentido em uma mesma frase. Mas hoje descrevem um movimento cada vez mais comum. Afinal, o que é agricultura urbana?',
    imagemCard: 'https://germinnecomp-img.s3.sa-east-1.amazonaws.com/artigo1.png'
  },
  {
    artigoId: 3,
    titulo: 'Como hortas urbanas reduzem as ilhas térmicas nas cidades',
    descricao: 'Como as hortas urbanas podem reduzir o calor nas cidades. como as plantas e o solo ajudam a criar ambientes mais frescos e saudáveis, contribuindo para amenizar as ilhas térmicas urbanas.',
    categoria: 'Cultivo',
    data: '11 de setembro de 2023',
    fonte: 'Por: GerminneCompany',
    conteudo: `<article id="artigo-blog" className="artigo-blog">
              
    <figure>


      <img id="imagem-artigo" src='https://germinnecomp-img.s3.sa-east-1.amazonaws.com/Cidade.svg' alt="Cidade Quentex "/>
    ...
    <figure>
      ...
      <img src='https://germinnecomp-img.s3.sa-east-1.amazonaws.com/CasalCuidandoPlanta.svg' alt="" id="imagem-artigo" />
      <figcaption>Fonte: Nome do Autor</figcaption>
...
Existem muitas maneiras de ajudar a promover hortas urbanas. Você pode:</p>
    ...
    imagemCard: 'https://germinnecomp-img.s3.sa-east-1.amazonaws.com/artigo2.png'
  },
  {
    artigoId: 4,
    titulo: 'Como Fazer uma Horta Caseira – Passo a Passo Completo',
    descricao: 'Realmente ter uma hortas em casa é um privilégio para poucos? A resposta é: não, e chegou a hora de aprender a como fazer uma horta caseira mesmo com pouco espaço em casa!',
    categoria: 'Cultivo',
    ...
    <figure>
      ...
      <img id="imagem-artigo" src='https://germinnecomp-img.s3.sa-east-1.amazonaws.com/Plantando.jpg' alt="Pessoa plantando " />
    ...
    <figure>
      ...
      <img id="imagem-artigo" src='https://germinnecomp-img.s3.sa-east-1.amazonaws.com/PlantaFlorescendo.jpg' alt=" Planta Florescendo " />
    ...
    <figure>
      ...
      <img id="imagem-artigo" src='https://germinnecomp-img.s3.sa-east-1.amazonaws.com/CriancaRegando.png' alt="Criança Regando " />
    ...
    <figure>
      ...
      <img id="imagem-artigo" src='https://germinnecomp-img.s3.sa-east-1.amazonaws.com/cultivandoplantaBlog.jpg' alt=" Cultivando uma planta " />
    ...
    <figure>
      ...
      <img id="imagem-artigo" src='https://germinnecomp-img.s3.sa-east-1.amazonaws.com/dicaBrota.jpg' alt="Dicas Brota " />
    ...
    <figure>
      ...
      <img id="imagem-artigo" src='https://germinnecomp-img.s3.sa-east-1.amazonaws.com/TerranaGarrafa.jpg' alt=" Terra  " />
    ...
    imagemCard: 'https://germinnecomp-img.s3.sa-east-1.amazonaws.com/artigo3.png'
  },
  // {
  //   artigoId: 5,
  //   titulo: 'Para que servem as hortas? Conheça 5 utilidades delas',
  //   data: '15 de Setembro de 2022',
  //   fonte: 'Por: BrotaCompany',
  //   descricao: 'Vivemos em um mundo que cada vez mais busca uma reconexão com a natureza. E nesse contexto, as hortas despontam como algo comum, nos bairros e nas casas. Mas afinal, para que servem as hortas?',
  //   conteudo: `<article className="artigo-blog">
  //   <figure>
  //     <img
  ...
  //   </div>
  // </article>`,
  //   imagemCard: 'https://germinnecomp-img.s3.sa-east-1.amazonaws.com/artigo4.png',
  ...
  //   </div>
  // </article>`,
  //   titulo: 'Os benefícios secretos que uma horta em casa pode trazer',
  //   descricao: 'Ter sua própria horta pode render para você diversas plantas lindas que irão deixar o ambiente com sua cara ou colheitas deliciosas que vão direto pra sua mesa do jantar.',
  //   categoria: 'Curiosidades',
  //   data: '13 de Janeiro de 2023',
  //   fonte: 'Por: BrotaCompany',
  //   imagemCard: 'https://germinnecomp-img.s3.sa-east-1.amazonaws.com/artigo5.png'
  // },
  // {
  //   artigoId: 7,
  //   conteudo: `<article className="artigo-blog">
  ...
  //     <img id="imagem-artigo" src={Salada} alt="Prato de salada " />
  ...
  //     <img id="imagem-artigo" src={Pote} alt="Prato de salada " />
  ...
  // </article>`,
  //   titulo: 'Aprenda a fazer uma salada russa!',
  //   descricao: 'A salada preferida do churrasco! Com o sabor neutro da batata, o adocicado da cenoura, a acidez do picles e a cremosidade da maionese, ela conquista o paladar de todos. Faça em seu churrasco e se prepare para receber muitos elogios!',
  //   categoria: 'Agricultura Urbana',
  //   data: '11 de Maio de 2021',
  //   fonte: 'Por: TUDOGOSTOSO',
  //   imagemCard: 'https://germinnecomp-img.s3.sa-east-1.amazonaws.com/artigo6.png'
  // },
  // {
  //   artigoId: 8,
  //   conteudo: `<article className="artigo-blog">
  ...
  //     <img id="imagem-artigo" src={PlantarCoentro} alt="Prato de salada " />
  ...
  //     <img id="imagem-artigo" src={Residencia} alt="Prato de salada " />
  ...
  //     <img id="imagem-artigo" src={PlantasnaMesa} alt="Prato de salada " />
  ...
  // </article>`,
  //   titulo: 'Confira algumas dicas de como plantar coentro em apartamento!',
  //   descricao: 'Por conta do espaço limitado, pessoas que moram em apartamentos têm ressalvas quanto a ter uma horta em casa, Mas não seria ótimo poder se abastecer de tempero a qualquer hora?',
  //   categoria: 'Alimentação Saudável',
  //   data: '22 de Setembro de 2023',
  //   fonte: 'Por: SANCHZ DESIGN',
  //   imagemCard: 'https://germinnecomp-img.s3.sa-east-1.amazonaws.com/artigo7.png'
  // }
];
